...
class syscoonFinanceinterfaceXML(models.TransientModel):
    ...
    def get_invoice_item_list(self, move_id, invoice_mode):
        ...
        if float_repr(total_invoice_amount, 2) != float_repr(move_id.amount_total, 2):
            ...
            last_val['price_line_amount']['gross_price_line_amount'] = move_id.currency_id.round(last_val['price_line_amount']['gross_price_line_amount'] - difference)
    ...
    def _get_invoice_item_list_item(self, move_id, line, invoice_mode):
        ...
        if invoice_mode == 'extended':
            ...
            if not line.account_id.datev_automatic_account:
                ...
                item['accounting_info']['bu_code'] = False
            item['accounting_info']['cost_category_id'] = line.analytic_account_id and line.analytic_account_id.code or False
            item['accounting_info']['cost_category_id2'] = line.analytic_tag_ids and line.analytic_tag_ids[0].name or False
        return item
